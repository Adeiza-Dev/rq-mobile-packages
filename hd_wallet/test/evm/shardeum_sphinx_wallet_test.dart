...
void main() {
  group('Create Shardeum Sphinx Wallet tests', () {
    test('Shardeum Wallet 0 Test', () {
      final hdWallet = HDWalletEuc.fromRecoveryPhrase(recoveryPhrase, env);
      AccountWallet wallet = hdWallet.getAccountWallet("shardeum_sphinx", accountIdx: 0);
    ...
    test('Shardeum Sphinx Wallet 1 Test', () {
      final hdWallet = HDWalletEuc.fromRecoveryPhrase(recoveryPhrase, env);
      AccountWallet wallet = hdWallet.getAccountWallet("shardeum_sphinx", accountIdx: 1);
